...
def _segm_saicr(pretrained, args, criterion):
    ...
    d_model = 256
    num_classes = 2
    num_vis_prompts = 5   # Mask Prompts
    ...
    model = SAICR(backbone, pixel_decoder, args, num_classes=num_classes, criterion=criterion)
    return model

def saicr(pretrained='', args=None, criterion=None):
    return _segm_saicr(pretrained, args, criterion)